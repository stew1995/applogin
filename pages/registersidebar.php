<form name="basicRegister" class="registrationForm" id="basicForm" action="registerInsert.php" onsubmit="return formValidation();">
  <h1>Register</h1>
    ...
    <p>Gender<input type="radio" name="Gender" value="Male"><input type="radio" name="Gender" value="Female"></p>
    <p id="reqgender"><span class="required">*<span id="genderErr"> </span></span></p>
